...
Camera::Platformer(olc::vf2d _position, olc::Decal *_decal){
    ...
    olc::vf2d camera_clamp_min = centre;
    olc::vf2d camera_clamp_max = clamp_down_right_corner - centre;
...
olc::vf2d Camera::WorldToScreen(olc::vf2d _position, olc::vf2d _shape_offset){
    olc::vf2d screen_position = (_position - position)*scale + centre/scale;
